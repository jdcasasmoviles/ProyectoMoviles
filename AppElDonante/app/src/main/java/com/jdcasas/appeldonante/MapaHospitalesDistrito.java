...
public class MapaHospitalesDistrito extends AppCompatActivity {
    String Respuesta="";
    String distrito="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_hospitales_distrito);
        ...
        while(!Respuesta.equals("")){
            //toma la cadena 0 hasta un *
            fila = Respuesta.substring(0, Respuesta.indexOf('*'));
             double coorX=Double.parseDouble(fila);
            //mocha la cadena desde * en adelante hasta el final
            Respuesta = Respuesta.substring(Respuesta.indexOf('*') + 1, Respuesta.length());
            //toma la cadena 0 hasta un *
            fila = Respuesta.substring(0, Respuesta.indexOf('*'));
           double coorY=Double.parseDouble(fila);
           //mocha la cadena desde * en adelante hasta el final
            Respuesta = Respuesta.substring(Respuesta.indexOf('*') + 1, Respuesta.length());
           //toma la cadena 0 hasta un *
           fila = Respuesta.substring(0, Respuesta.indexOf('*'));
           ...
           //mocha la cadena desde * en adelante hasta el final
           Respuesta = Respuesta.substring(Respuesta.indexOf('*') + 1, Respuesta.length());
           System.out.println(coorX+" "+coorY+" "+fila+" "+fila2);
           setMarker(new LatLng(coorX, coorY), fila,
                   fila2 + "\nDistrito " + distrito, 0.5F, 0.5F, 0.5F, R.drawable.maphospital);
        }
