...
public class SampleMaterialAdapter extends RecyclerView.Adapter<SampleMaterialAdapter.ViewHolder> {
    ...
    public void addCard(String name, int color) {
        ...
        cardsList.add(card);
        ((BuscarDonantesActivity) context).doSmoothScroll(getItemCount());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    Pair<View, String> p1 = Pair.create((View) initial, BuscarDonantesActivity.TRANSITION_INITIAL);
                    Pair<View, String> p2 = Pair.create((View) name, BuscarDonantesActivity.TRANSITION_NAME);
                    Pair<View, String> p3 = Pair.create((View) deleteButton, BuscarDonantesActivity.TRANSITION_DELETE_BUTTON);
                    ...
                    transitionIntent.putExtra(BuscarDonantesActivity.EXTRA_NAME, name);
                    transitionIntent.putExtra(BuscarDonantesActivity.EXTRA_INITIAL, Character.toString(name.charAt(0)));
                    transitionIntent.putExtra(BuscarDonantesActivity.EXTRA_COLOR, color);
                    transitionIntent.putExtra(BuscarDonantesActivity.EXTRA_UPDATE, false);
                    transitionIntent.putExtra(BuscarDonantesActivity.EXTRA_DELETE, false);
