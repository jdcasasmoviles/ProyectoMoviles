...
public class MapaUsuarioGps extends AppCompatActivity {
    String Respuesta="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_usuario_gps);
        ...
        setMarker(new LatLng(coorcamaraX, coorcamaraY), fila,
                fila2 , 0.5F, 0.5F, 0.5F, R.drawable.mapusuariogps);
